...
When installing through UPM Git URL, you need to install and configure DOTween yourself, otherwise the runtime assembly may fail to compile.
...
如果使用 UPM Git URL 安装，需要自行安装并配置 DOTween，否则 Runtime 程序集可能无法编译。
